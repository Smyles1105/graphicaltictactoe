...
def main():
    ...
    #     moves = 0
    #     boardIsFilled = False
    #     while moves < 9 or boardIsFilled is False:
    #         coords = getCoords(win)
    #         qdrt = getQuadrant(coords)
    #         move = verifyMove(board, qdrt, win, title)
    #         if move[0]:
    #             drawMove(move[1], win)
    #             board[qdrt[0]][qdrt[1]] = 1
    #             moves+=1
    #         boardIsFilled = checkBoard(board)
    #

    #

    #
    # def verifyMove(board, quadrant, window, title):
    #     win = window
    #     title = title
    #     moveValid = False
    #     while moveValid == False:
    #         if board[quadrant[0]][quadrant[1]] == 2:
    #             moveValid = True
    #             return moveValid, quadrant
    #         else:
    #             title.setText("Invalid Board Move, pick an empty one.")
    #             coords = getCoords(window)
    #             qdrt = getQuadrant(coords)
    #             moveValid = verifyMove(board, qdrt, win, title)
    #
    #     return moveValid, qdrt
    #
    # def drawMove(quadrant, window, player):
    #
    #
    #
    # def computerMove(window, board):
    #     if board[1][1] == 2:
    #         drawMove([1, 1], window, "computer")
    #     return 0.0
